 ...
 * Generated at: 2020-10-26 15:24:11 UTC
...
sessionNotification.removeAttribute("warning");
      ...
      out.write("\t\t\t\t\t\t\t\t<h2>Update Category details</h2>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
...
try{ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t<form action=\"ProductUpdateServlet\" method=\"post\">\r\n");
      out.write("\t\t\t\t\t\t\t<input type=\"hidden\" name=\"operation\" value=\"category\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"exampleInputEmail1\">Category Title</label> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttype=\"text\" class=\"form-control\" id=\"exampleInputEmail1\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tname=\"categoryTitle\" value=\"");
      out.print(category.getCategoryTitle());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"exampleInputEmail1\">Category Description</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<textarea name=\"categoryDescription\" style=\"height: 80px\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttype=\"text\" class=\"form-control\" id=\"exampleInputEmail1\">");
      ...
      out.write("\t\t\t\t\t\t\t\t<hr>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"container text-center\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-success\">Save\r\n");
