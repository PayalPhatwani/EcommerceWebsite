 ...
 * Generated at: 2020-10-25 17:03:21 UTC
...
sessionNotification.removeAttribute("warning");
      ...
      out.write("\t\t\t\t\t\t\t\t<label for=\"exampleInputEmail1\">Email address</label> <input name=\"userEmail\"\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<label for=\"exampleInputPassword1\">Password</label> <input name=\"userPassword\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\ttype=\"password\" class=\"form-control\" id=\"exampleInputPassword1\">\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"container text-center\">\r\n");
      out.write("\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-success btn-lg btn-block\">Log In</button><br>\r\n");
      out.write("\t\t\t\t\t\t\t<button type=\"reset\" class=\"btn btn-warning btn-lg btn-block\">Reset</button><br>\r\n");
      out.write("\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t<a href=\"#\">Forgot password?</a>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<hr>\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"container text-center\">\r\n");
      out.write("\t\t\t\t\t\t\t<button class=\"btn btn-primary \">Create a new Account</button>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</form>\r\n");
      out.write("\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
