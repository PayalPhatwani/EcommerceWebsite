 ...
 * Generated at: 2020-10-26 11:09:47 UTC
...
sessionNotification.removeAttribute("warning");
      ...
      out.write("\t\t\t\t\t\t\t<h3 class=\"text-center my-3\">Update Profile</h3>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(updateProfile.getUserId());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"userName\">User Name</label> <input name=\"userName\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttype=\"text\" class=\"form-control\" id=\"username\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\taria-describedby=\"emailHelp\" placeholder=\"Enter userName\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(updateProfile.getUserName());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"userEmail\">User Email</label> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tname=\"userEmail\" type=\"email\" class=\"form-control\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tid=\"useremail\" aria-describedby=\"emailHelp\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tplaceholder=\"Enter Email\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(updateProfile.getUserEmail());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"userphone\">User Phone </label> <input\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tname=\"userPhone\" class=\"form-control\" id=\"userphone\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\ttype=\"text\" placeholder=\"Enter Phone no.\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tvalue=\"");
      out.print(updateProfile.getUserPhone());
      out.write("\">\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"useraddress\">User Address</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<textarea style=\"height: 80px\" type=\"text\" class=\"form-control\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tname=\"userAddress\" id=\"useraddress\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tplaceholder=\"Enter address\">");
      out.print(updateProfile.getUserAddress());
      out.write("\r\n");
      out.write(" \t\t\t\t\t\t</textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
